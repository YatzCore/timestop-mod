...
def main():
 ...
 write_json(DATA/'timestop/recipes/copper_pedestal.json',{'type':'minecraft:crafting_shaped','pattern':['CCC',' W ','SSS'],'key':{'C':{'item':'minecraft:copper_ingot'},'W':{'item':'minecraft:clock'},'S':{'item':'minecraft:stone_bricks'}},'result':{'id':'timestop:copper_pedestal'}})
 for tier,prev,material in [('golden','copper','gold_ingot'),('diamond','golden','diamond')]:
  write_json(DATA/f'timestop/recipes/{tier}_pedestal.json',{'type':'minecraft:crafting_shaped','pattern':[' M ','MPM',' M '],'key':{'M':{'item':'minecraft:'+material},'P':{'item':f'timestop:{prev}_pedestal'}},'result':{'id':f'timestop:{tier}_pedestal'}})
 write_json(DATA/'timestop/recipes/netherite_pedestal.json',{'type':'minecraft:smithing_transform','template':{'item':'minecraft:netherite_upgrade_smithing_template'},'base':{'item':'timestop:diamond_pedestal'},'addition':{'item':'minecraft:netherite_ingot'},'result':{'id':'timestop:netherite_pedestal'}})
