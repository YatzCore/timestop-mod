...
public class RewindRegressionTests implements FabricGameTest {
    ...
    private void checkInteractionAfterRewind(GameTestHelper h, boolean continuous) {
        ...
        player.connection = new net.minecraft.server.network.ServerGamePacketListenerImpl(level.getServer(),
                new net.minecraft.network.Connection(net.minecraft.network.protocol.PacketFlow.SERVERBOUND), player, net.minecraft.server.network.CommonListenerCookie.createInitial(player.getGameProfile(), false)) {
    ...
    public void missingUpdateAndTransientDespawnNeverRespawn(GameTestHelper h) {
        ...
        frame.addEntityDelta(new EntityDelta(level.dimension(), id, EntityDelta.Type.UPDATE,
                net.minecraft.resources.ResourceLocation.parse("minecraft:pig"), state, null));
        ...
        transientFrame.addEntityDelta(EntityDelta.despawn(level.dimension(), id, net.minecraft.resources.ResourceLocation.parse("minecraft:pig"), state));
    ...
    public void corruptEntityDoesNotAbortBlockRestoration(GameTestHelper h) {
        ...
        frame.addEntityDelta(EntityDelta.despawn(level.dimension(), id, net.minecraft.resources.ResourceLocation.parse("minecraft:pig"), state));
