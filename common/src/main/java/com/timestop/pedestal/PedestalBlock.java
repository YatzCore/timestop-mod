...
public class PedestalBlock extends BaseEntityBlock {
    ...
    public static final com.mojang.serialization.MapCodec<PedestalBlock> CODEC = com.mojang.serialization.Codec.STRING
            .xmap(name -> new PedestalBlock(WatchTier.valueOf(name)), block -> block.tier.name()).fieldOf("tier");
    @Override protected com.mojang.serialization.MapCodec<PedestalBlock> codec() { return CODEC; }
