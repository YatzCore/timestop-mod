...
public final class ObservatoryPiece extends StructurePiece {
    ...
    public static ResourceLocation templateId(String variant) { return ResourceLocation.fromNamespaceAndPath("timestop","ruined_observatory/"+variant); }
    ...
    public static StructurePlaceSettings settings(String variant, Rotation rotation) {
        ...
        return new StructurePlaceSettings().setRotation(rotation).setRotationPivot(pivot(variant)).setIgnoreEntities(true).setLiquidSettings(net.minecraft.world.level.levelgen.structure.templatesystem.LiquidSettings.IGNORE_WATERLOGGING).setKnownShape(true);
    }
